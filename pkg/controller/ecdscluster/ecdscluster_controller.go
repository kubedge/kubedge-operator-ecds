...
import (
	...
	ecdsmgr "github.com/kubedge/kubedge-operator-ecds/pkg/ecdscluster"
...
func addECDSCluster(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &av1.ECDSCluster{}), &crthandler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ECDSClusterReconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
